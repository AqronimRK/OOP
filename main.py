...
student1 = Student('Roman', 'K', 'Male')
student2 = Student('Tim', 'Z', 'Male')
lector1 = Lecturer('Some', 'Lector')
lector2 = Lecturer('Oleg', 'Bulygin')
reviewer1 = Reviewer('SomeRev', 'Number One')
reviewer2 = Reviewer('SomeRev', 'Number Two')


student1.finished_courses = ['Testers']
...
student1.rate_lesson(lector1, 'Python', random.randint(1, 5))
student1.rate_lesson(lector2, 'Python', random.randint(1, 5))
student2.rate_lesson(lector1, 'Python', random.randint(1, 5))
student2.rate_lesson(lector2, 'JS', random.randint(1, 5))

reviewer1.rate_hw(student1, 'Python', random.randint(1, 5))
reviewer1.rate_hw(student2, 'Python', random.randint(1, 5))
reviewer2.rate_hw(student1, 'Python', random.randint(1, 5))
reviewer2.rate_hw(student2, 'JS', random.randint(1, 5))
